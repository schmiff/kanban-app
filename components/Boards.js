...
const Boards = () => {
  ...
  return (
    <div className="h-full transition-all ease-in duration-200" style={!isOpen ? {height: 80}: {height: 480}}>
    ...
    {/* Board Expand and Collapse Logic + Styling */}
      <div className="overflow-hidden transition-all ease-in duration-200" style={isOpen ? { height: 400 + "px" }: {height: 1 + "px"}}>
        {/* Board Columns */}
