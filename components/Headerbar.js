  ...
  return (
    <header className="flex w-full flex items-center justify-end h-16 bg-slate-800 text-right shadow-md">
        <div className="flex items-center pt-1 ">
                <div className='flex text-slate-200 h-16 cursor-pointer rounded-l-lg hover:bg-slate-200 hover:text-slate-800 hover:ease-linear hover:duration-200 py-3 pr-5'>
                        ...
                        <div className="flex flex-wrap rounded-full h-10 w-10 shadow-sm  border-2 border-blue-400">
